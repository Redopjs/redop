...
description: The runtime-agnostic TypeScript framework for production MCP servers — tools, resources, prompts, plugins, hooks, and HTTP or stdio transports on Bun, Node, Cloudflare, or Vercel.
---
...
See [Runtime adapters](/reference/runtime-adapters) and [Deploy to Production](/guides/deploy/index).
