...
If you still need a container setup from scratch, start with [Deploy with Docker](/guides/deploy/docker) and come back once your Redop app builds cleanly in Docker.
